...
export class SnakeService {
  ...
  private canChangeDirection(
    ...
    var givenDirectionOpposite =
      this.directionHelper.getOppositeDirection(givenDirection);

    return !(
      wantedDirection === givenDirection ||
      wantedDirection === givenDirectionOpposite
    );
  }
}
